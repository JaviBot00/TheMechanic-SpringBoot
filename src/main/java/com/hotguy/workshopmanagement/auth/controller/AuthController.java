package com.hotguy.workshopmanagement.auth.controller;
...
import com.hotguy.workshopmanagement.auth.service.AuthService;
 ...
 *
 * <p>
 * {@code @RestController}: combina {@code @Controller} y {@code @ResponseBody}.
 ...
 *
 * <p>
 * {@code @RequestMapping("/api/v1/auth")}: prefijo común para todos los
...
public class AuthController {
     ...
     *
     * <p>
     * {@code @Valid}: activa Bean Validation sobre el DTO de entrada.
     ...
     * La autorización por rol se verifica en
     * {@link com.hotguy.workshopmanagement.config.SecurityConfig}.
     *
     ...
     *
     * <p>
     * {@code @AuthenticationPrincipal}: inyecta el {@code UserDetails} del usuario
     * autenticado en la petición actual, extraído del SecurityContext por Spring
     * Security.
