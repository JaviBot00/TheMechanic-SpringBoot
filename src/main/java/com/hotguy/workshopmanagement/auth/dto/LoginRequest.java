 ...
 *
 * <p>
 * Contiene las credenciales del usuario. Se validan automáticamente
 * con Bean Validation antes de llegar al Service.
 *
 * <p>
 * Usamos {@code record} de Java 17+ en lugar de clase con Lombok porque
 * los records son inmutables por naturaleza y más concisos para DTOs simples.
 *
 * @param username nombre de usuario
 * @param password contraseña en texto plano (solo en tránsito HTTPS, nunca se
 *                 persiste)
 */
