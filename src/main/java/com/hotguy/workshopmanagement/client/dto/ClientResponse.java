package com.hotguy.workshopmanagement.client.dto;
 ...
 *
 * <p>
 * Solo expone los campos seguros: no incluye campos internos de JPA
 * ({@code deletedAt}) ni referencias circulares ({@code vehicles} completos).
 * El número de vehículos se expone como contador para evitar cargas
 * innecesarias.
 *
