 ...
 *
 * <p>
 * {@code @RestControllerAdvice}: intercepta las excepciones lanzadas en
 * cualquier
 * {@code @RestController} y permite devolver respuestas HTTP apropiadas en
 * lugar de
 * propagarlas como errores 500 genéricos.
 *
 * <p>
 * Usamos {@link ProblemDetail} (RFC 9457), el estándar moderno de Spring Boot
 * 3+
