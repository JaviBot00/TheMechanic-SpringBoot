...
/**
 * Configuración de SpringDoc OpenAPI para la documentación automática de la
 * API.
 *
 * <p>
 * {@code @OpenAPIDefinition}: define los metadatos globales de la API
 * (título, versión, contacto) y los requisitos de seguridad globales.
 *
 * <p>
 * {@code @SecurityScheme}: define el esquema de autenticación JWT Bearer
 ...
 *
 * <p>
 * Con esta configuración, Swagger UI mostrará un candado en cada endpoint
