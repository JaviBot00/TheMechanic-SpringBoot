 ...
 *
 * <p>
 * Spring Security utiliza estos roles para controlar el acceso a los
 ...
 *
 * <p>
 * Los roles definen niveles de acceso:
 * <ul>
 * <li>{@code ADMIN}: acceso total, gestión de usuarios</li>
 * <li>{@code MECHANIC}: gestión de tareas y vehículos, sin gestión de
 * usuarios</li>
