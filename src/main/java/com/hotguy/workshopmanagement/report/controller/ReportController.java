package com.hotguy.workshopmanagement.report.controller;

import com.hotguy.workshopmanagement.report.dto.SummaryReportResponse;
import com.hotguy.workshopmanagement.report.service.ReportService;
 ...
 * Accesible por ADMIN y MECHANIC (definido en SecurityConfig y @PreAuthorize
 * del Service).
 */
@RestController
