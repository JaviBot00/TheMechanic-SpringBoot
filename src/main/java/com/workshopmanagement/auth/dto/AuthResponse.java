 ...
 *
 * <p>Devuelve los dos tokens necesarios para el cliente:
 * <ul>
 *   <li>{@code accessToken}: JWT de corta duración (1h) que se envía en cada request</li>
 *   <li>{@code refreshToken}: token opaco de larga duración (7 días) para renovar el access token</li>
 * </ul>
 *
