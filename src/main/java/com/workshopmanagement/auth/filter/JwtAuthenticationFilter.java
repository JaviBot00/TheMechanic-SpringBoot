package com.workshopmanagement.auth.filter;

import com.workshopmanagement.auth.service.JwtService;
 ...
 * </pre>
 *
 * <p>El {@code SecurityContext} es un almacenamiento por hilo (ThreadLocal) que
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
     ...
     * @param filterChain la cadena de filtros (debemos llamar a {@code doFilter} para continuar)
     */
    @Override
    protected void doFilterInternal(
        ...
        // 3. Extraer el username del token. Si el token es inválido, jwtService lanzará excepción
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtService.isTokenValid(jwt, userDetails)) {
                ...
                //    credentials = null porque ya no necesitamos la contraseña (el JWT es la prueba)
