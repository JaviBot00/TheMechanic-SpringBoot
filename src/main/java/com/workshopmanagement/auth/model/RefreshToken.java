 ...
 *
 * <p>Los refresh tokens permiten renovar el access token JWT sin que el usuario
...
public class RefreshToken extends AuditableEntity {
     ...
     * Una vez superada esta fecha, el token no puede usarse aunque no esté revocado.
     */
     ...
     *
     * @return {@code true} si el token puede usarse para generar un nuevo access token
     */
