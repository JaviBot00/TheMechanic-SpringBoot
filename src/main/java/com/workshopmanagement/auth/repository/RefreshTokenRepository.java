...
public interface RefreshTokenRepository extends JpaRepository<RefreshToken, Long> {
     ...
     *
     * <p>{@code @Modifying} indica que esta query modifica datos (no es SELECT).
     * Requiere estar dentro de una transacción ({@code @Transactional} en el Service).
     * {@code clearAutomatically = true} limpia el contexto de persistencia de JPA
     * después de la actualización para evitar que entidades en memoria queden obsoletas.
     *
