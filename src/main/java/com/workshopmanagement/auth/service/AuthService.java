package com.workshopmanagement.auth.service;
...
import com.workshopmanagement.auth.model.RefreshToken;
import com.workshopmanagement.auth.model.User;
import com.workshopmanagement.auth.repository.RefreshTokenRepository;
import com.workshopmanagement.auth.repository.UserRepository;
import com.workshopmanagement.client.repository.ClientRepository;
import com.workshopmanagement.common.exception.ResourceNotFoundException;
import com.workshopmanagement.config.JwtProperties;
 ...
 *
 * <p>{@code @Transactional} a nivel de clase hace que todos los métodos
...
public class AuthService {
     ...
     *
     * <p>Internamente, {@code AuthenticationManager.authenticate()} verifica las
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        //    Internamente: carga el UserDetails por username, compara el hash de la contraseña.
        ...
        // 3. Revocar tokens anteriores del usuario (seguridad: una sesión activa por usuario).
     ...
     *
     * <p>Implementa "refresh token rotation": al usar el refresh token,
