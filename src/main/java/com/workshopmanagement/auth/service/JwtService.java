 ...
 *
 * <p>Un JWT tiene tres partes separadas por puntos:
 * <pre>
 ...
 *   <li><b>Payload</b>: claims (datos): subject (username), rol, expiración, etc.</li>
 *   <li><b>Signature</b>: HMAC del header+payload con la clave secreta</li>
 * </ul>
 *
 * <p>El token es <b>stateless</b>: el servidor no necesita guardarlo. Solo necesita
 * la clave secreta para verificar que la firma es válida. Si alguien manipula el
