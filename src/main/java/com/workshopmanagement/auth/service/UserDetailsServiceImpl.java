 ...
 * para obtener los datos del usuario (credenciales, roles, estado de la cuenta).
 * Es el puente entre Spring Security y nuestra BD.
 *
 * <p>Al inyectarse en {@code SecurityConfig} como bean, Spring Security lo usa
...
public class UserDetailsServiceImpl implements UserDetailsService {
     ...
     *
     * <p>{@code @Transactional(readOnly = true)}: operación de solo lectura.
     ...
     * @return el {@link UserDetails} del usuario (nuestra entidad {@code User} lo implementa)
