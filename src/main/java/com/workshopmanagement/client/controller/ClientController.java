 ...
 * </ul>
 *
 * <p>La autorización se delega al {@link ClientService} mediante {@code @PreAuthorize}.
 * El Controller solo gestiona HTTP: recibe peticiones, valida, delega, devuelve respuesta.
 */
@RestController
...
public class ClientController {
     ...
     * Roles: ADMIN, MECHANIC.
     *
     * <p>{@code @PageableDefault}: valores por defecto de paginación si el cliente
     * no especifica parámetros. Equivale a ?page=0&size=20&sort=surname1,asc.
     * El cliente puede sobreescribirlos con query params: ?page=1&size=10&sort=name,desc
     *
