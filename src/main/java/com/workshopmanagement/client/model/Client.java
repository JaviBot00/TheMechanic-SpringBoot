package com.workshopmanagement.client.model;

import com.workshopmanagement.auth.model.User;
import com.workshopmanagement.common.model.Person;
 ...
 *
 * <p>Hereda los campos de persona ({@code name}, {@code surname1}, {@code nif}, etc.)
 * de {@link Person} y añade el código de cliente y la lista de vehículos asociados.
 *
 * <p>{@code @SQLRestriction("deleted_at IS NULL")} hace que Hibernate aplique
 * automáticamente este filtro a todas las queries sobre esta entidad, implementando
...
public class Client extends Person {
     ...
     * {@code @OneToOne(mappedBy = "client")} indica que la FK está en la tabla users.
     */
