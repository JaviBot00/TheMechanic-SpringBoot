package com.workshopmanagement.client.repository;
 ...
 *
 * <p>Spring Data genera automáticamente las implementaciones SQL.
...
public interface ClientRepository extends JpaRepository<Client, Long> {
    ...
    /**
     * Busca clientes cuyo primer apellido contenga el texto dado (insensible a mayúsculas).
     * Devuelve resultados paginados.
     *
     * <p>La paginación evita cargar miles de registros en memoria de golpe.
    ...
    /**
     * Busca un cliente por su código de cliente (el código de negocio, no el ID técnico).
     *
