...
/**
 * Servicio auxiliar para evaluar permisos de acceso específicos del dominio cliente.
 *
 * <p>Se usa en expresiones {@code @PreAuthorize} para comprobar si el usuario
 ...
 * </pre>
 *
 * <p>Spring Security evalúa la expresión SpEL (Spring Expression Language) antes
 * de ejecutar el método. El {@code @} en {@code @clientSecurityService} referencia
...
public class ClientSecurityService {
     ...
     *
     * <p>Un cliente solo puede acceder a sus propios datos.
     *
