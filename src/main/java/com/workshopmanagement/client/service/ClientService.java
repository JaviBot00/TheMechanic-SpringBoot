 ...
 *
 * <p>Esta capa actúa como intermediaria entre el Controller (que maneja HTTP)
 * y el Repository (que accede a la BD). La lógica de negocio nunca va en el
 * Controller ni en el Repository.
 *
 * <p>{@code @Transactional}: todos los métodos públicos se ejecutan dentro de
...
public class ClientService {
     ...
     *
     * <p>{@code @PreAuthorize("hasAnyRole('ADMIN','MECHANIC')")}:
     ...
     *
     * <p>Un CLIENT solo puede ver sus propios datos. La expresión SpEL
     * {@code @preAuthorize} accede al SecurityContext para obtener el usuario actual
