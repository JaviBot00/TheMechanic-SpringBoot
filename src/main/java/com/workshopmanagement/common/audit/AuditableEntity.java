package com.workshopmanagement.common.audit;
 ...
 *
 * <p>Al extender esta clase, una entidad hereda automáticamente cuatro campos:
 * <ul>
 ...
 * </ul>
 *
 * <p>Los campos {@code createdAt} y {@code updatedAt} se gestionan automáticamente
 * por Spring Data JPA gracias a {@code @EntityListeners(AuditingEntityListener.class)},
 * que requiere que {@code @EnableJpaAuditing} esté activo en la clase principal.
 *
 * <p>{@code @MappedSuperclass} indica a JPA que esta clase no es una entidad por sí
