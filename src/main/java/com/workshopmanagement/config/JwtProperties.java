...
/**
 * Clase de configuración que lee las propiedades JWT del fichero {@code application.yml}.
 *
 * <p>{@code @ConfigurationProperties(prefix = "security.jwt")} indica a Spring Boot
 * que lea todas las propiedades que empiecen por {@code security.jwt} y las mapee
 ...
 * </pre>
 *
 * <p>Spring Boot convierte automáticamente el kebab-case del YAML ({@code secret-key})
...
public class JwtProperties {
     ...
     * En producción debe venir de la variable de entorno {@code SECURITY_JWT_SECRET_KEY}.
