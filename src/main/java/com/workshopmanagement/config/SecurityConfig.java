...
import com.workshopmanagement.auth.filter.JwtAuthenticationFilter;
 ...
 *
 * <p>{@code @EnableWebSecurity}: activa la integración de Spring Security con Spring MVC.
 * <p>{@code @EnableMethodSecurity}: activa las anotaciones de seguridad a nivel de método
 * ({@code @PreAuthorize}, {@code @PostAuthorize}), que usaremos en los Controllers y Services
...
public class SecurityConfig {
     ...
     *
     * <p>Este es el método más importante de toda la configuración de seguridad.
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // El resto de endpoints autenticados se controlan con @PreAuthorize en los controllers
                ...
                // la autenticación en el SecurityContext antes de que Spring Security la compruebe.
                .addFilterBefore(jwtAuthFilter, UsernamePasswordAuthenticationFilter.class)

                // Configurar las cabeceras HTTP para permitir la consola H2 en un iframe (solo dev)
     ...
     * </ul>
     *
     * <p>Spring Security lo usa internamente en el {@code AuthenticationManager}
     ...
     *
     * <p>El {@code AuthenticationManager} es el componente central que coordina
     ...
     *
     * <p>BCrypt es el estándar de la industria para hashear contraseñas:
     * <ul>
     ...
     * </ul>
     *
     * <p>NUNCA almacenar contraseñas en texto plano ni con MD5/SHA1.
     *
