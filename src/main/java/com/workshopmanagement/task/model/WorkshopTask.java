package com.workshopmanagement.task.model;

import com.workshopmanagement.client.model.Client;
import com.workshopmanagement.common.audit.AuditableEntity;
import com.workshopmanagement.mechanic.model.Mechanic;
 ...
 *
 * <p>Una tarea de taller vincula un {@link Vehicle}, un {@link Mechanic}
 * y un {@link Client}, y gestiona el ciclo de vida completo de una reparación:
 * diagnóstico → trabajo en progreso → finalización → pago.
 *
 * <p>El coste se calcula dinámicamente a partir de las horas reales trabajadas
 * y las tarifas del tipo de vehículo (delegando en {@link Vehicle#calculatePrice}).
 */
@Getter
@Setter
@SuperBuilder
...
public class WorkshopTask extends AuditableEntity {
     ...
     * y las tarifas del tipo de vehículo. Devuelve 0 si la tarea no está finalizada.
     *
    ...
    public String getStatus() {
        ...
        if (realHours > 0) return "En progreso";
        return "Pendiente";
    }
}
