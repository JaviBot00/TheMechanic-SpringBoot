package com.workshopmanagement.vehicle.model;
 ...
 *
 * <p>La lógica de tarifas se ha movido al enum {@link VehicleType},
 ...
 *
 * <p>Un vehículo pertenece siempre a un {@link Client} y puede tener
...
public class Vehicle extends AuditableEntity {
    ...
    public float getCompletionPercentage() {
        if (workshopTasks.isEmpty()) return 0f;
