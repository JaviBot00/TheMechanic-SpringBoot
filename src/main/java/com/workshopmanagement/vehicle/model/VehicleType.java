 ...
 *
 * <p>Cada tipo define una tarifa horaria ({@code hourlyRate}) y una tarifa fija
 * por dificultad ({@code fixedFee}) que se aplica independientemente de las horas.
 * La fórmula de facturación es: {@code (horas × hourlyRate) + fixedFee}.
 *
 * <p>Al almacenar el enum en la BD se guarda el {@code name()} (el texto del enum,
