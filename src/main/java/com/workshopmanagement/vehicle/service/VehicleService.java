package com.workshopmanagement.vehicle.service;
...
import com.workshopmanagement.vehicle.mapper.VehicleMapper;
...
public class VehicleService {
    ...
    public void deleteVehicle(Long id) {
        ...
        if (activeTasks > 0) {
            throw new IllegalStateException("No se puede eliminar: el vehículo tiene " + activeTasks + " tarea(s) activa(s)");
        }
        vehicle.softDelete();
