 ...
 *
 * <p>{@code @SpringBootTest}: levanta el contexto completo de Spring Boot
 ...
 *
 * <p>{@code @AutoConfigureMockMvc}: configura {@link MockMvc} para simular
 ...
 *
 * <p>{@code @ActiveProfiles("dev")}: usa la configuración del perfil dev
 * (H2 en memoria), evitando dependencias de PostgreSQL en los tests.
 *
 * <p>{@code @Transactional}: cada test se ejecuta en una transacción que
