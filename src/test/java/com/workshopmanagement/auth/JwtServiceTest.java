package com.workshopmanagement.auth;
 ...
 *
 * <p>{@code @ExtendWith(MockitoExtension.class)}: activa la integración de Mockito
 * con JUnit 5. Mockito crea automáticamente los mocks anotados con {@code @Mock}
 * e inyecta los necesarios en la clase bajo test ({@code @InjectMocks}).
 *
 * <p>Estos tests son "unitarios puros": no levantan el contexto de Spring,
